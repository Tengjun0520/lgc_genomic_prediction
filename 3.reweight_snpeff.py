...
##get lgc
lgc_file = 'tr1.tr2.bivar.lava' ##local genetic correlation estimation using lava
lava_part_file = 'block.txt' ## lava partitioning
...
for blocks in open('block_snp_num.txt'):
    block = blocks.split()
